        ...
        if(!verifyLoading && result !== VERIFY_STATUS.VALID ){
          dispatch(
            verifyDrmEmpNo({
              ...
              {isDrm && (
                <>
                  ...
                  <Spin spinning={!isAuthorized || fetchLoading}>
                    <RootKey svcId={svcId} isEditing={editingRootKey} setIsEditing={setEditingRootKey} />
                  </Spin>
                  {/* 허용 IP 관리 */}
                  <Divide $border={false} top={20} bottom={0} />
                  <Spin spinning={!isAuthorized || fetchLoading}>
                    <AllowIpList svcId={svcId} isEditing={editingAllowIp} setIsEditing={setEditingAllowIp} />
                  </Spin>
                </>
              )}
            </>
