...
with st.sidebar:
    ...
    # 모델 선택 메뉴
    selected_model = st.selectbox("LLM 선택", ["ollama", "x-ai/grok-4-fast", "deepseek/deepseek-chat-v3.1:free", "tngtech/deepseek-r1t2-chimera:free", "z-ai/glm-4.5-air:free"], index=0)
...
# 체인 생성
def generate_answer(image_filepath, system_prompt, user_prompt, model_name = "ollama"):
    # 객체 생성
