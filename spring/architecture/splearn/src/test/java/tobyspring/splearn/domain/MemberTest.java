...
class MemberTest {
    ...
    void changeNickname() {
        ...
        member.changeNickname("Rose");

        assertThat(member.getNickname()).isEqualTo("Rose");
    }
    ...
    void invalidEmail() {
        ...
        Member.create(new MemberCreateRequest("invalid@email.com", "Toby", "secret"), passwordEncoder);
    }
